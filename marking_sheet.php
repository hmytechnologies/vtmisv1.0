...
if ($_REQUEST['action'] == "getPDF") {
    ...
    class PDF extends FPDF
    {
        ...
        function BasicTable($header, $sectionHeaderA)
        {
            ...
            $L = array(10,97,5,97.5); // Adjust column widths
            for ($i = 0; $i < 6; $i++) {
                $this->Cell($L[$i], 10, $sectionHeaderA[$i], 1, 0, 'C');
            }
            $this->Ln(); // Move to the next line
            $w = array(10,40, 13.5, 13.5,30, 5, 13.5,13.5 ,13.5, 13.5,13.5,30,30,37.6); // Adjust column widths
    ...
    $header = array('No', 'Exam Number', 'Q 1', 'Q 2', 'S/TOTAL', '', 'Q 3', 'Q 4', 'Q 5', 'Q 6', 'Q 7', 'S/TOTAL ','PRACTICAL','TOTAL');
    $sectionHeaderA =  array('', 'SECTION A', '','SECTION B');
