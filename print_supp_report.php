...
if($_REQUEST['action']=="getPDF")
{
    ...
    $student = $db->getStudentSuppProgramme($programmeID,$academicYearID,$studyYear,$batchID);
    if(!empty($student)) {
        ...
        foreach ($student as $st) {
            ...
            foreach ($studentDetails as $std) {
                ...
                foreach ($course as $cs) {
                    ...
                    $pdf->Cell($wdth, 6, $courseCode . "-" . $sup . "-" . $grade, 1);
                }
