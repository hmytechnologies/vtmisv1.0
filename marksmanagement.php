                                            ...
                                            <div class="box-body table-responsive">
                                                <table id="" class="table table-striped table-bordered table-condensed">
                                                    <thead>
                                                        <tr>
                                                            <th>Total Credits: </th>
                                                            <td style="font-size: 18px;"><strong><span class="text-danger"><?php echo $totalUnits; ?></span></strong></td>
                                                        </tr>
                                                        <tr>
                                                            <th>Total Points</th>
                                                            <td style="font-size: 18px;"><strong><span class="text-danger"><?php echo $totalPoints; ?></span></strong></td>
                                                        </tr>
                                                        <tr>
                                                            <th>Overall GPA</th>
                                                            <td style="font-size: 18px;"><strong><span class="text-danger"><?php echo $db->convert_gpa($db->getGPA($totalPoints, $totalUnits)); ?></span></strong></td>
                                                        </tr>
                                                        <tr>
                                                            <th>Remarks</th> <?php $gpa = $db->convert_gpa($db->getGPA($totalPoints, $totalUnits)); ?>
                                                            <td style="font-size:18px;"><strong><span class="text-danger"><?php echo $db->getGPARemarks($regNumber, $gpa); ?></span></strong></td>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
