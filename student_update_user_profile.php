...
<div class="row well">
    ...
    <form name="register" method="post" id="register" action="" onsubmit="return checkForm(this);">
        <div class="col-md-6">
            ...
            <div class="row">
                <div class=" left-addon form-group has-feedback">
                    <input type='text' id="phone_number" name="phoneNumber" placeholder="Valid Phone Number" class="form-control" required="" />
                    <i class="form-control-feedback glyphicon glyphicon-lock"></i>
                </div>
            </div>
            ...
            <div class="row">
                <div class=" left-addon form-group has-feedback">
                    <input type='text' id="email" name="email" placeholder="Valid Email Address" class="form-control email" required/>
                    <i class="form-control-feedback glyphicon glyphicon-lock"></i>
                </div>
            </div>
            <div class="row">
