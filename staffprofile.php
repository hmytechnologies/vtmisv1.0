...
$instructor = $db->getRows('instructor',array('where'=>array('userID'=>$userID),'order_by'=>'firstName ASC'));
if(!empty($instructor)) {
    $x = 0;
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="hidden" name="instructorID"
                                               value="<?php echo $inst['instructorID']; ?>">
                                        <input type="hidden" name="action_type" value="edit"/>
                                        <input type="submit" name="doSubmit" value="Update Records"
