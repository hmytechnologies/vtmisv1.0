<div class="row">
   ...
   /* $academicYearID=$_POST['academicYearID'];*/
    ...
    $student = $db->getStudentSuppProgramme($programmeID,$semesterID,$studyYear,$batchID);
    if(!empty($student))
    {
    ?>
...
/*            $course=$db->getAnnualSuppCourseCredit($regNumber,$programmeID,$academicYearID);*/
                    $course=$db->getSuppCourseCredit($regNumber,$programmeID,$semesterID);
            $tunits=0;
            $tpoints=0;
            $countpass=0;
            $countsupp=0;
            foreach ($course as $cs)
             {
                 ...
                 echo "<td>$courseCode($sup-$grade)</td><td></td>";
             }
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!--<embed src="print_supp_report.php?action=getPDF&prgID=<?php /*echo $programmeID;*/?>&bid=<?php /*echo $batchID;*/?>&aid=<?php /*echo $academicYearID;*/?>&syear=<?php /*echo $studyYear;*/?>"
                       frameborder="0" width="100%" height="600px">-->

                <embed src="print_supp_report_new.php?action=getPDF&prgID=<?php echo $programmeID;?>&bid=<?php echo $batchID;?>&sid=<?php echo $semesterID;?>&syear=<?php echo $studyYear;?>"
                       frameborder="0" width="100%" height="600px">
