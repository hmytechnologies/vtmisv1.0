...
if($_REQUEST['action']=="getPDF") {
    ...
    $semesterSettingID = $_REQUEST['sid'];
    ...
    $pdf->Text(10, 16, 'EXAMINATION RESULTS FOR '.$db->getData("semester_setting", "semesterName", "semesterSettingID", $semesterSettingID)."-".$db->getData("batch", "batchName", "batchID", $batchID));
    $pdf->Line(10,18,205,18);
