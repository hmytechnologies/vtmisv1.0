...
-<?php echo $db->getData("batch","batchName","batchID",$batchID);?></span></h4>
        ...
        <div class="row">
            <?php
            $student = $db->getStudentSpecialExamResult($courseID,$semesterSettingID,$batchID);
            if(!empty($student))
            {
                ?>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <embed src="print_special_report.php?action=getPDF&cid=<?php /*echo $courseID;*/?>&bid=<?php /*echo $batchID;*/?>&sid=<?php /*echo $semesterSettingID;*/?>"
