...
?>
<div class="container">
    <h4>Add Special Result for <span class="text-danger">
<?php
$courseID=$db->decrypt($_REQUEST['cid']);
...
?>
    ...
    <div class="row">
        <div class="col-lg-6">
            <?php
            $examCategoryID=4;
            $student= $db->getStudentSpecialList($courseID,$semesterID,$batchID);
            ?>
            ...
            <form name="" method="post" action="action_exam_score.php">
                ...
                <table  id="onlydata" border=1 class="table table-striped table-bordered table-condensed">
                    ...
                    ?>
                        ...
                        <input type='text' hidden name="examNumber<?php echo $count;?>" value="<?php echo $st['examNumber'];?>">
                            <input type='text' hidden name="regNumber<?php echo $count;?>" value="<?php echo $st['regNumber'];?>">
                            <td><?php echo $name;?></td>
                            <td><?php echo $st['examNumber'];?></td>
...
/*                                        }
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <input type="hidden" name="action_type" value="add_special"/>
