...
<div class="row">
    <div class="col-md-8">
        <div class="pull-left">
            <h3>List of Registered Instructors</h3>
        </div>
    </div>
<div class="col-md-4">
...
<?php  
            $db = new DBHelper();
            $instructor = $db->getRows('instructor',array('order_by'=>'employmentStatusID DESC'));
?>
...
// $schoolCode=$db->getData("schools","schoolCode","schoolID",$schooID);
 ...
 ?>
            <tr>
               ...
               <!-- <td><img id="image" src="student_images/<?php /*echo $inst['instructorImage'];*/?>" height="100px" width="120px;" /></td>-->
                <!--<td>
