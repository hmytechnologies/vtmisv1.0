                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input type="text" name="relationship" value="<?php echo $nrelation;?>" class="form-control"  required />
                                    </div>
                                </div>
                                </div></div></fieldset>
                    <hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="others">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" name="sponsoremail" value="<?php echo $sponsoremail;?>"  class="form-control" />
                                        </div>
                                    </div>
