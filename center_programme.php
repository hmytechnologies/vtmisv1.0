        ...
        <div class="row">
            ...
            <div class="row">
                ...
                ?>
                    <div class="col-lg-12">
                        <div class="row">
                            <h4 class="text-info">Register New Trade for <?php echo $db->getData('center_registration', 'centerName', 'centerRegistrationID', $centerRegistrationID); ?></h4>
                        </div>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <select name="programme_level_id[]" class="form-control chosen-select" multiple>
                                        ...
                                        if (!empty($programmeLevel)) {
                                            echo "<option value=''>Please Select Here</option>";
                                            $count = 0;
                                            foreach ($programmeLevel as $plevel) {
                                                $count++;
                        ...
                        <tbody>
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="action_center_programme_mapping.php?action_type=delete&pid=<?php echo $db->my_simple_crypt($user['programmeID'], 'e'); ?>&centerID=<?php echo $db->my_simple_crypt($centerRegistrationID,'e'); ?>" class="glyphicon glyphicon-trash" title="Drop"></a>
                                            </td>
                                        </tr>
                            <?php }
                                }
