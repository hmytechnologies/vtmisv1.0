        ...
        <div class="row">
            ...
            if(isset($_POST['doFind'])=="Find Records" ||(isset($_REQUEST['action'])=="getRecords"))
            {
                if(isset($_POST['doFind'])=="Find Records") {
                    ...
                    $course=$db->getCourseProgramme($programmeID,$academicYearID,$programmeLevelID);
                ...
                if(!empty($course))
                {
                    ...
                    <div class="row">
                        <h4 class="text-info">
                            Assign Subjects for <?php echo $db->getData("programme_level","programmeLevel","programmeLevelID",$programmeLevelID);?> - <?php echo $db->getData("programmes","programmeName","programmeID",$programmeID);?>
                ...
                $courseprogramme = $db->getRows('courseprogramme',array('where'=>array('programmeID'=>$programmeID,'academicYearID'=>$academicYearID),' order_by'=>' courseID ASC'));
                            ...
                            if(!empty($course))
                            {
                                ...
                                foreach($course as $c)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="action_semister_course.php?action_type=delete&id=<?php echo $db->my_simple_crypt($courseProgrammeID,'e'); ?>&programmeID=<?php echo $db->my_simple_crypt($programmeID,'e');?>&academicYearID=<?php echo $db->my_simple_crypt($academicYearID,'e');?>&levelID=<?php echo $db->my_simple_crypt($programmeLevelID,'e');?>"
