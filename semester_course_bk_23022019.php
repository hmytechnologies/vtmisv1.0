    ...
    <div class="content">
        ...
        <div class="row">
            ...
            if(isset($_POST['doFind'])=="Find Records" ||(isset($_REQUEST['action'])=="getRecords"))
            {
                ...
                {
                    //$course=$db->getCourseByMapping($_SESSION['department_session'],$programmeID,$batchID,$studyYear,$semisterID);
                    /*$course = $db->getRows('programmemaping',array('where'=>array('programmeID'=>$programmeID,'studyYear'=>$studyYear,'semesterID'=>$semisterID),' order_by'=>' courseID ASC'));*/
                    $course = $db->getRows('programmemaping',array('where'=>array('programmeID'=>$programmeID),' order_by'=>' courseID ASC'));
                }
                ...
                $courseprogramme = $db->getRows('courseprogramme',array('where'=>array('programmeID'=>$programmeID,'studyYear'=>$studyYear,'semesterSettingID'=>$semisterID,'batchID'=>$batchID),' order_by'=>' courseID ASC'));
