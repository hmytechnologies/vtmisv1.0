...
<script type="text/javascript">
    $(document).ready(function()
    {
        $("#assessmentTypeID").change(function()
        {
            ...
            var dataString = 'examCategoryID='+ examCategoryID+'&assessmentTypeID='+assessmentTypeID+'&courseID='+courseID+'&academicYearID='+academicYearID+'&examDate='+examDate+'&programmeLevelID='+programmeLevelID+'&programmeID='+programmeID;
            $.ajax
            ({
                type: "POST",
                url: "ajax_add_assessment.php",
                data: dataString,
                cache: false,
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="form-group">
                <label for="email">Current Term</label>
                <select name="examCategoryID" class="form-control" id="examCategoryID">
                    <?php
                    /*$exam_category=$db->getAssessmentTypeCategory($courseTypeID);*/
        ...
        <div class="col-lg-3">
            <div class="form-group">
                ...
                <select name="assessmentTypeID" class="form-control" id="assessmentTypeID">
                    <?php
                    $exam_category=$db->getAssessmentTypeCategory($courseTypeID);
                    if(!empty($exam_category)){
                        ...
                        {
                            $examCategory=$prg['assessmentType'];
                            $examCategoryID=$prg['assessmentTypeID'];
                            echo "<option value='$examCategoryID'>$examCategory</option>";
                        }
                    }
                    ?>
