  ...
  <div class="content">
    ...
    ?>    
        ...
        <fieldset>
            ...
            <legend>Accomodation Information</legend>
            <div class="row">
                <div class="col-lg-10">
                    <div class="row">
                        <div class="col-lg-3">
                            <label for="gender">Hosteller</label>
                            <input type="text" name="" value="<?php echo $hosteller;?>" class="form-control" disabled>
                        </div>
...
<!--<a href="index3.php?sp=studentform">Edit My Profile</a>-->