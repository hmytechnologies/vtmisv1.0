...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            $course=$db->getCourseProgramme($programmeID,$batchID);
...
/*                }
            ...
            <form name="" method="post" action="action_register_course.php">
                    <table  id="example" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <tfoot>
                            <th colspan="4">Total Number of Credits</th>
                            <th colspan="3" align="right"><?php echo $totalCredits;?></th>
                            </tfoot>
                        </tr>
                    </table>
                    <div class="row">
