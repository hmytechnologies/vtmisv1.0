            ...
            <li class="header"><h2>Main Menu</h2> </li>
              ...
              <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                          ...
                          ?>
                      <li class="treeview">
                          <a href="#"><i class="glyphicon glyphicon-th-large"></i><span>Academics</span> <i
                      ...
                      <li class="treeview">
                          <a href="#"><i class="glyphicon glyphicon-th-large"></i> <span>Examinations</span> <i
                                      class="fa fa-angle-left pull-right"></i></a>
                          <ul class="treeview-menu">
                              <?php
                              foreach($_SESSION['roleID'] as $role=>$user_role) {
                                  if($user_role == 7 || $user_role == 4 || $user_role == 9)
                                  {
                                      ...
                                      <li><a href="index3.php?sp=annual_result">Annual Report</a></li>
                                      <li><a href="index3.php?sp=supp_report">Supp/Special Report</a></li>
                      ...
                      ?>
                      <li class="treeview">
                          <a href="#"><i class="glyphicon glyphicon-th-large"></i> <span>Finance</span> <i
                                      class="fa fa-angle-left pull-right"></i></a>
                          <ul class="treeview-menu">
              ...
              foreach($_SESSION['roleID'] as $role=>$user_role) {
                  if ($user_role == 6) {
                      ?>
                      <li class="treeview">
                          <a href="#"><i class="glyphicon glyphicon-th-large"></i> <span>Payment Setting</span> <i
                                      class="fa fa-angle-left pull-right"></i></a>
                          <ul class="treeview-menu">
              ...
              ?>
                      ...
                      ?>
                      <li class="treeview">
                          <a href="#"><i class="glyphicon glyphicon-th-large"></i> <span>Statistical Reports</span> <i
                                      class="fa fa-angle-left pull-right"></i></a>
                          <ul class="treeview-menu">
                          </ul>
                      </li>
              ...
              foreach($_SESSION['roleID'] as $role=>$user_role) {
                  if ($user_role == 1) {
                      ?>
                      <li class="treeview">
                          <a href="#"><i class="glyphicon glyphicon-th-large"></i> <span>Center Management</span> <i
                                      class="fa fa-angle-left pull-right"></i></a>
                          <ul class="treeview-menu">
              ...
              foreach($_SESSION['roleID'] as $role=>$user_role) {
                  if ($user_role == 1) {
                      ?>
                      <li class="treeview">
                          <a href="#"><i class="glyphicon glyphicon-th-large"></i> <span>User Management</span> <i
                                      class="fa fa-angle-left pull-right"></i></a>
                          <ul class="treeview-menu">
             ...
             ?>
                  ...
                  <li class="treeview">
                      <a href="#"><i class="glyphicon glyphicon-th-large"></i> <span>Infor Corner</span> <i
                                  class="fa fa-angle-left pull-right"></i></a>
                      <ul class="treeview-menu">
              ...
              <li class="treeview">
                  <a href="#"><i class="glyphicon glyphicon-th-large"></i> <span>My Account</span> <i
                              class="fa fa-angle-left pull-right"></i></a>
                  <ul class="treeview-menu">
