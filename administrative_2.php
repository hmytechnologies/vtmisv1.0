...
<!--    <div class="row">-->
<!--        <div class="col-sm-7">-->
<!--            <h2 class="text-info" style="font-family: segoe UI;"></h2>-->
<!--        </div><br/>-->
<!--        <div class="col-sm-3">-->
<!--            <a href="index3.php?sp=HR_configurations" class="btn btn-info form-control"> Back to System Configurations</a>-->
<!--        </div>-->
<!---->
<!--    </div>-->
    ...
    <div class="container">
        <div class="content">
            ...
            <div class="tab-content">
                ...
                <!--region-->
                <div id="zone" class="tab-pane fade in active">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-right">
