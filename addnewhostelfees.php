...
<div class="container">
    <h4>Define Hostel Fees</h4>
    <hr>
    <form name="" method="post" action="action_add_hostel_fees.php">
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-4">
                ...
                <div class="row">
                    <table id="admit" class="display nowrap" cellspacing="0">
                        ...
                        <tbody>
                        <?php
                        $users = $db->getRows('feestype',array('where'=>array('feesID'=>2,'feesTypeStatus'=>1),'order_by'=>'feesTypeID ASC'));
                        if(!empty($users)){
                            $count = 0;
