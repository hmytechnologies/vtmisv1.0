...
if(!empty($studentID))
{
    ...
    foreach ($studentID as $std)
    {
        ...
        $study_year = $db->getRows('student_study_year', array('where' => array('regNumber' => $regNumber, 'academicYearID' => $academicYearID), ' order_by' => 'studyYear ASC'));
        if (!empty($study_year)) {
...
-->                                          <input type="hidden" name="number_student" value="<?php echo $count; ?>">
                        ...
                        {
                            ?>
                            <h4 class="text-danger">Course Registration is closed,for more information contact examination office</h4>
                            <?php
                        }
                        ?>
                    </div>
        ...
        if (!empty($courseList)) {
            ...
            <table class="table table-striped table-bordered table-condensed" >
                ...
                foreach ($courseList as $list) {
                    ...
                    $coursestatus = $db->getSemesterProgrammeCourse($programmeID,$semesterSettingID,$batchID);
                    foreach($coursestatus as $csc) {
                        /*$count++;
                        $courseID = $std['courseID'];
                        $batchID = $std['batchID'];
                        $courseProgrammeID = $std['courseProgrammeID'];
                        $studyYear = $std['studyYear'];*/
                        $cStatus = $csc['courseStatus'];
                    }
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal">
                    <div class="box-body">
                        ...
                        {
                            $totalSemester=0;$totalSPP=0; $totalAPC=0;$totalAPP=0;
                            ...
                            <div class="box-body table-responsive">
                                <table class="table table-striped table-bordered table-condensed">
                                    ...
                                    <tr>
                                        <td>Total Fees:</td>
                                        <td>
                                            <strong><?php echo number_format($totalFeesP); ?></strong>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Semester Fees:</td>
                                        <td>
                                            <strong><?php echo number_format($totalFeesP / 2); ?></strong>
                                        </td>
                                        <td>Required Fees per Semester</td>
                                    </tr>
                                    <?php
                                    if (($totalSemester < $totalFeesP / 2) && ($today >= $endDateF)) {
                                        ?>
                                        <tr>
                                            <td>
                                                Penalty
                                            </td>
                                            <td><strong><?php echo number_format($penalty); ?></strong></td>
                                            <td>Late University Payment</td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
              ...
              --><?php
                    ...
                    //{
                    ?>
                    <h5 class="text-danger">Sorry,You have Outstanding balance, Clear Outstanding Balance to Finalize Registration</h5>
                    <?php
                    //}
                    //} //end of else statement for exam number
                    ?>
                    <!-- /.box-body -->
                    <!--<div class="box-footer">
                      <button type="button" class="btn btn-primary pull-right" style="margin-right: 5px;">
                  <i class="fa fa-download"></i> Print PDF</button>
                    </div>-->
                    <!-- /.box-footer -->
                </form>
            </div>
